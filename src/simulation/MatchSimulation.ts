...
export class MatchSimulation {
  ...
  advanceForTest(seconds:number){ const wasPaused=this.paused; this.paused=false; this.tick(seconds); this.paused=wasPaused; }
