...
export class GameScene extends Phaser.Scene {
  ...
  private createRobot(r:Robot):void {
    ...
    const labelY=r.archetype==='goalkeeper'?(r.team==='blue'?34:-60):(r.team==='blue'?27:-42);
